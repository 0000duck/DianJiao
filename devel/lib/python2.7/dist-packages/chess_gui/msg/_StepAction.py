...
"""autogenerated by genpy from chess_gui/StepAction.msg. Do not edit."""
import sys
...
class StepAction(genpy.Message):
  _md5sum = "59980bd559bbeeb61b9498d9a7fc72c3"
  _type = "chess_gui/StepAction"
...
"""
  ...
  _slot_types = ['chess_gui/StepActionGoal','chess_gui/StepActionResult','chess_gui/StepActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StepAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = chess_gui.msg.StepActionGoal()
      if self.action_result is None:
        self.action_result = chess_gui.msg.StepActionResult()
      if self.action_feedback is None:
        self.action_feedback = chess_gui.msg.StepActionFeedback()
    else:
      self.action_goal = chess_gui.msg.StepActionGoal()
      self.action_result = chess_gui.msg.StepActionResult()
      self.action_feedback = chess_gui.msg.StepActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2f().pack(_x.action_goal.goal.max_x, _x.action_goal.goal.max_y))
      length = len(self.action_goal.goal.ops)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.ops:
        _x = val1
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.action_result.result.res))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.max_x, _x.action_goal.goal.max_y,) = _get_struct_2f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.ops = []
      for i in range(0, length):
        ...
        self.action_goal.goal.ops.append(val1)
      _x = self
      start = end
      end += 12
      ...
      (self.action_result.result.res,) = _get_struct_B().unpack(str[start:end])
