...
"""autogenerated by genpy from chess_msgs/StepActionGoal.msg. Do not edit."""
import sys
...
class StepActionGoal(genpy.Message):
  _md5sum = "39ea5d0a689a1407a71b7f6e3e65a984"
  _type = "chess_msgs/StepActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','chess_msgs/StepGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = chess_msgs.msg.StepGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = chess_msgs.msg.StepGoal()
