...
"""autogenerated by genpy from chess_msgs/StepActionFeedback.msg. Do not edit."""
import sys
...
class StepActionFeedback(genpy.Message):
  ...
  _type = "chess_msgs/StepActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','chess_msgs/StepFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = chess_msgs.msg.StepFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = chess_msgs.msg.StepFeedback()
